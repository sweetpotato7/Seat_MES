...
namespace MESProject
{
    class SQL // 가져온 파일, 수정해야됨
    {
        ...
        //학원
        //public SqlConnection con = new SqlConnection("server = 61.83.51.99, 1433; Database=MES; Uid=sa; Pwd=password2021!@;");
        
        //집
        public SqlConnection con = new SqlConnection("server = 221.161.208.134, 1433; Database=MES; Uid=sa; Pwd=@(%$WDB!&N;");
